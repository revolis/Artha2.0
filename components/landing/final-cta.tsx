    ...
    <section className="mx-auto w-full max-w-6xl px-5 py-16">
      <Reveal y={24}>
        <div className="overflow-hidden rounded-2xl border">
          {/* The registry background forces a black radial gradient and white
              stars; both are overridden so the panel keeps the theme's card
              surface and the stars read as faint accent specks. */}
          <StarsBackground
            className="bg-card"
          ...
          >
            <div className="relative flex flex-col items-center gap-5 px-6 py-20 text-center">
              ...
              <p className="max-w-lg leading-relaxed text-balance text-muted-foreground">
                ...
                live. Change the display currency, interrogate the charts, add
                an entry of your own — then create an account when you are ready
                to keep your own.
              </p>
